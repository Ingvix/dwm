...
static char selbordercolor[]        = "#557700";
static char selbgcolor[]            = "#557700";
...
static const char *dmenucmd[] = { "dmenu_run", "-c", "-l", "20", "-g", "3", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             -1,         XK_k,      incnmaster,     {.i = +1 } },
	{ MODKEY|ShiftMask,             -1,         XK_j,      incnmaster,     {.i = -1 } },
